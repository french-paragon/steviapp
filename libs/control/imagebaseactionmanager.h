...
protected:
    ...
    QAction* createAssignToTrajectoryAction(QObject* parent, Project* p, const QVector<Image *> &ims) const;
    QAction* createAssignToMountingAction(QObject* parent, Project* p, const QVector<Image *> &ims) const;
